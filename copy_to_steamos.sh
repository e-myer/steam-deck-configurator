...
cp -vr functions.sh configure_deck_cli.sh configure_deck_at_once.sh configure_deck_gui.sh SteamDeck_rEFInd rEFInd_configs $HOME/.deck_setup/steam-deck-configurator/
