...
install_refind() {
    ...
    chmod +x "$HOME/.deck_setup/build/steam-deck-configurator/SteamDeck_rEFInd/install-GUI.sh" # make the install GUI script executable
    ...
    echo "rEFInd config installation cancelled"
    fi
}
