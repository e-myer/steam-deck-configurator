...
### Note: This project is work-in-progress, the code has not been tested on a Steam Deck, as I don't currently have access to one. Exercise caution and conduct your own testing before use. Feedback and contributions are welcome.
---
